...
ggplot(data = mpg) + geom_point(mapping = aes(x = displ, y = hwy, color = class, shape = drv, size = cyl))+ ggtitle(label = "Highway fuel efficiency vs.Engine size (displacement in L) for vehicle")
